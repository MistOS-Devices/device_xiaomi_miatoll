...
TARGET_BOARD_KERNEL_HEADERS := kernel/xiaomi/sm6250/include/uapi
...
TARGET_KERNEL_ADDITIONAL_FLAGS += HOSTCC=clang HOSTCXX=clang++ LD=ld.lld AR=llvm-ar NM=llvm-nm STRIP=llvm-strip OBJCOPY=llvm-objcopy OBJDUMP=llvm-objdump
